...
import practical.work.two.practicalwithspring.repository.CoachRepository;
    ...
    public boolean save(CoachDTO dto) {
        ...
        coach.setPokemons(dto.getPokemons().stream()
                .map(dtoPok -> {
                    ...
                    pokemon.setLife(Integer.parseInt(dtoPok.getLife()));
                    pokemon.setAttack(Integer.parseInt(dtoPok.getAttack()));
